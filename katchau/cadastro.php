        ...
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron d-flex justify-content-center">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link" href="cadcarros.php" style="color: #FD2F4C !important; font-size:22px;">Carro <i class="fas fa-car-alt"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cadcliente.php" style="color: #FD2F4C !important; font-size:22px;">Cliente <i class="fas fa-user"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="cadaluguel.php" style="color: #FD2F4C !important; font-size:22px;">Aluguel <i class="fas fa-exchange-alt"></i></a>
                        </li>
                    </ul>
                </div>
        </div>
