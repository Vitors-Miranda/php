...
<body>
  ...
  <div class="container my-5">
    <?php
      ...
      $ddd = $arrayCelular[0];
      $celular = str_replace("-","",$arrayCelular[1]);

      $sql = "INSERT INTO tbl_contatos VALUES(0,:nome,:email,:ddd,:celular)";
    ...
    <div class="alert alert-success">
      <i class="far fa-check-circle"></i> Contato cadastrado com sucesso!
    </div>
  </div>
</body>
